...
******************************************************************************
*/
#if defined(MALATA_E1003) && defined(CUSTOMER_BQ)    
/* for bq_edison3 only, the speaker's rated power is 1.0w, counting the line loss of the wire.
it is OK to set PA's limited power to 1.2w.*/
static int Speaker_Volume=2;
#elif defined(MALATA_E1003) && defined(CUSTOMER_EDU)
static int Speaker_Volume=4;
#else
