...
MTK_MODEM_PATH := $(foreach p,$(CUSTOM_MODEM),mediatek/custom/$(PROJECT)/modem/$(p))
...
$(foreach m,$(CUSTOM_MODEM),\
	$(eval s := $(filter-out mediatek/custom/$(PROJECT)/modem/$(m)/modem_feature_%.mak,$(wildcard mediatek/custom/$(PROJECT)/modem/$(m)/modem*.mak)))\
