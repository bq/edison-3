...
#	$SHEET_NAME = "emmc";
	if($PROJECT eq "e7003"
		|| $PROJECT eq "e7801"
		|| $PROJECT eq "qmobile_e7801"
		|| $PROJECT eq "qmobile_e7007"
		|| $PROJECT eq "qmobile_e7006"
		|| $PROJECT eq "d7814"
		|| $PROJECT eq "dt_7851"
		|| $PROJECT eq "mas"
		|| $PROJECT eq "pmt3177_3g"
		|| $PROJECT eq "dns_e1002"
		|| $PROJECT eq "m_mp10pa3g"
		|| $PROJECT eq "m_mp8pa3g"
		|| $PROJECT eq "pmp7070c3g"
		|| $PROJECT eq "es_e1002"
		|| $PROJECT eq "pmt5008_3g"
		|| $PROJECT eq "pmt5018_3g"
		|| $PROJECT eq "m142g_e1002"
		|| $PROJECT eq "bq_edison3_3g_e1010"
		|| $PROJECT eq "fnac_40_10_3g_e1010"
		){
