 ...
 */
static ssize_t imod_show(struct kobject *kobj, struct kobj_attribute *attr,
			char *buf)
{
...
static struct kobj_attribute imod_attribute =
	__ATTR(imod, 0666, imod_show, imod_store);
 ...
 */
static ssize_t dburst_show(struct kobject *kobj, struct kobj_attribute *attr,
			char *buf)
{
...
static struct kobj_attribute dburst_attribute =
	__ATTR(dburst, 0666, dburst_show, dburst_store);
