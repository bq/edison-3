...
#if defined(OV5694AF)
extern PFUNC_GETLENSDEFAULT pOV5694AF_getDefaultData;
#endif
...
#if defined(FM50AF)
	{OV5693_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_getDefaultData},
#endif

#if defined(OV5694AF)
	{OV5694_SENSOR_ID, OV5694AF_LENS_ID, "OV5694AF", pOV5694AF_getDefaultData},
#endif
