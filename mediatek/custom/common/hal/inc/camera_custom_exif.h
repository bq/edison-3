...
#include <cutils/properties.h>// add for use property_get by xmcwy 20140702
//
...
* Custom EXIF
******************************************************************************/
#define EN_CUSTOM_EXIF_INFO //open for custom EXIF by xmcwy 20140702
...
/*[A] add for custom EXIF by xmcwy 20140702*/
char strMakeBuf[PROPERTY_VALUE_MAX];
char strModelBuf[PROPERTY_VALUE_MAX];
property_get("ro.product.manufacturer", strMakeBuf, "");
property_get("ro.product.model", strModelBuf, "");
strMakeBuf[31] = '\0';
strModelBuf[31] = '\0';
memcpy(exifTag.strMake, (unsigned char *)strMakeBuf, 32);
memcpy(exifTag.strModel, (unsigned char *)strModelBuf, 32);
/*END fix Bug-ID 0025470 by xmcwy 20140702*/
