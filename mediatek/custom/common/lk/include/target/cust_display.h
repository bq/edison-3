...
#elif defined(WSVGA) || defined(PMT3177_3G)  || defined(QMOBILE_E7006) || defined(WSVGA_ANDROID)
	// wsvga 600*1024
...
#elif defined(WSVGANL) || defined(BLU_E7006)
	// wsvganl 1024*600
...
#elif defined(WXGANL) || defined(CUSTOMER_DNS) || defined(CUSTOMER_M_MP10PA3G) || defined(CUSTOMER_M142G) || defined(CUSTOMER_BQ)
	// wxganl 1280*800
...
#define NUMBER_TOP					 (190)
#define NUMBER_RIGHT				 (630)//585+45
#define NUMBER_BOTTOM				 (254) //95+64

#define PERCENT_LEFT				 (675) // percent number_left + 2*number_width
#define PERCENT_TOP 				 (190)
#define PERCENT_RIGHT				 (732) //675+57
#define PERCENT_BOTTOM				 (254)
...
#define BAR_BOTTOM			(640)
...
#elif defined(WXGA) || defined(CUSTOMER_M_MP8PA3G) || defined(MALATA_D7023) || defined(MALATA_E7007) || defined(WXGA_ANDROID) || defined(PMT5008_3G) || defined(PMT5018_3G) || defined(BLU_E8004)
	// wxga 800*1280
...
#elif defined(QMOBILE_E7801)  //xmxl@20140626:add for qmobile_e7801
    //768*1024
	// battery capacity rectangle
	#define CAPACITY_LEFT                (302) // battery capacity center
	#define CAPACITY_TOP                 (428)
	#define CAPACITY_RIGHT               (465) //465-302=163
	#define CAPACITY_BOTTOM              (689) //689-428=261
	...
	#define TOP_ANIMATION_LEFT           (302) //(297)//(316) // top animation
	#define TOP_ANIMATION_TOP            (428)
	#define TOP_ANIMATION_RIGHT          (302+163)//(470)//(451)
	#define TOP_ANIMATION_BOTTOM         (428+29)
