...
#define HSYNC_PULSE_WIDTH 358 //402 
#define HSYNC_BACK_PORCH   24//24
#define HSYNC_FRONT_PORCH  20//20
#define VSYNC_PULSE_WIDTH  29//35
#define VSYNC_BACK_PORCH   4///4
#define VSYNC_FRONT_PORCH  2///2
...
//	MT8193_REG_WRITE(LVDS_FMT_CTRL, RG_8BIT_FORMAT);//RG_6BIT_FORMAT -> 16bit LCM / RG_8BIT_FORMAT -> 18bit LCM 
}
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    /*[A] modify X dpi and Y dpi for GMS, xmwyq, 20140326 */
    params->physical_width  = 154;
...
/*    params->dpi.mipi_pll_clk_ref  = 0;
    ...
    params->dpi.mipi_pll_clk_div2 = 0x800AF42F;//0x800a0000;0x800AF42F
...
/*[M]Adjust the clk to RF,ArthurLin,20140505*/
#if MALATA_E7006
    params->dpi.mipi_pll_clk_ref  = 556870912;
#else
    params->dpi.mipi_pll_clk_ref  = 536870912;
#endif
/*[M]END,ArthurLin,20140505*/
    ...
    params->dpi.format            = LCM_DPI_FORMAT_RGB888;//LCM_DPI_FORMAT_RGB888;   // format is 24 bit
    params->dpi.rgb_order         = LCM_COLOR_ORDER_RGB;//LCM_COLOR_ORDER_BGR;
...
//#if defined(MALATA_D7023)
#define GPIO_LCD_PWR_EN		 GPIO115
#define GPIO_LCD_RST_EN      GPIO_UNSUPPORTED
...
static void lcm_init(void)
{
    ...
    pmic_config_interface(DIGLDO_CON28, 0x6, PMIC_RG_VGP1_VOSEL_MASK, PMIC_RG_VGP1_VOSEL_SHIFT);
...
static void lcm_resume(void)
{
    ...
    if(0 == u4Reg)
    {
        printf("[LK/LCM] lcm_resume() u4Reg=0\n");
        lcm_mt8193_enable_output();
    }
    MDELAY(100);
#elif (defined BUILD_UBOOT)
