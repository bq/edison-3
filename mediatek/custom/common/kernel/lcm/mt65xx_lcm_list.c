...
//yangshl add 2014.02.26
extern LCM_DRIVER clap070nj02cw_lcm_drv;
/* Added by Yangshl  @2014.02.10*/
extern LCM_DRIVER lsl070nl01_lcm_drv;
/* Added by Yangshl End */
//yangshl add end
/* Added by xmlwz  @2014.03.20*/
extern LCM_DRIVER clap070wp03_mt8193_lvds_lcm_drv;
/* Added by xmlwz End */
/*Added by xmyyq 20140414*/
extern LCM_DRIVER ee101ia_lcm_drv;
/* Added by xmylm, 20140423*/
extern LCM_DRIVER he080ia_lcm_drv;
/* Added by xmylm end*/
/* [A]Add by xmlq,2014.05.22*/
extern LCM_DRIVER p070acz_3z1_wsvga_dsi_lcm_drv;
/* [END]xmlq,2014.05.22*/
extern LCM_DRIVER adt07009d30_06_mipi_lcm_drv;
...
//ynaghsl add 2014.02.26
#if defined(CLAP070NJ02CW)
	&clap070nj02cw_lcm_drv,
#endif
//ynaghsl add end

/* Added by Yangshl @2014-02-10*/
#if defined(LSL070NL01)
	&lsl070nl01_lcm_drv,
#endif
/* Added by Yanghsl End*/

/* Added by xmlwz @2014-03-20*/
#if defined(CLAP070WP03_MT8193_LVDS)
	&clap070wp03_mt8193_lvds_lcm_drv,
#endif
/* Added by xmlwz End*/
/*Added by xmyyq 20140414*/
#if defined(EE101IA)
...
/* [A]Add by xmlq,2014.05.22*/
#if defined(P070ACZ_3Z1_WSVGA_DSI)
    &p070acz_3z1_wsvga_dsi_lcm_drv,
#endif
/* [END]xmlq,2014.05.22*/

#if defined(ADT07009D30_06_MIPI)
    &adt07009d30_06_mipi_lcm_drv,
#endif
