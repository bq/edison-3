...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    /*[A] modify X dpi and Y dpi for CTS test, xmwyq, 20140724 */
...
LCM_DRIVER cpt_ee101ia_lvds_lcm_drv = 
{
    .name		= "cpt_ee101ia_lvds",
