...
*/
    /* RGB interface configurations */
    params->dpi.mipi_pll_clk_ref  = 689362899;
...
LCM_DRIVER clap070wp03_mt8193_lvds_lcm_drv = 
{
    .name		= "clap070wp03_mt8193_lvds",
