...
#endif
#if defined(OV5694_MIPI_RAW)
    {OV5694_SENSOR_ID, SENSOR_DRVNAME_OV5694_MIPI_RAW, OV5694_MIPI_RAW_SensorInit}, 
#endif
...
#endif
/*Added by zhanghf @2014-01-21*/
#if defined(GC2235_MIPI_RAW)
    {GC223_SENSOR_ID, SENSOR_DRVNAME_GC2235_RAW, GC2235MIPISensorInit},
#endif

#if defined(GC2236_MIPI_RAW)
		{GC2236_SENSOR_ID, SENSOR_DRVNAME_GC2236_MIPI_RAW, GC2236MIPISensorInit}, 
#endif
