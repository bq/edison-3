...
******************************************************************************
*/
#if defined(MALATA_E1002) || defined(MALATA_E8001) || defined(MALATA_E1010)
...
void Sound_Speaker_Turnon(int channel)
{
    ...
    #if defined(MALATA_E7003) || defined(CUSTOMER_PMT3177_3G) || defined(MALATA_E7006) || defined(MALATA_Q18)
    // do nothing, amp 1.2w
    #elif 0 // amp 1.0w
...
{
		PRINTK("Audio_eamp_command, type=%d, args=%d, count=%d.\n", type, args, count);
