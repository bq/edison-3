...
#if defined(MALATA_E7003) || defined(CUSTOMER_PMT3177_3G) || defined(MALATA_E7006) || defined(MALATA_D7031) || defined(MALATA_D7023) || defined(MALATA_D7021) || defined(MALATA_E8006)
    #define SPK_WARM_UP_TIME        (40) //unit is ms
#elif defined(MALATA_E8004)
    #define SPK_WARM_UP_TIME        (45)
#else
...
void Sound_Speaker_Turnon(int channel)
{
    ...
    #if defined(MALATA_E7003) || defined(CUSTOMER_PMT3177_3G) || defined(MALATA_E7006) || defined(MALATA_D7021)
    // do nothing, amp 1.2w
    #elif 0 // amp 1.0w
