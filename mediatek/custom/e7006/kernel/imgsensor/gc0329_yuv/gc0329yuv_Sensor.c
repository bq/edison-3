...
#define SENSORDB(x,...)
#endif
/* 8389 add  Factory Camera auto test function by shone 2013-12-06 */
#define GC0329YUV_TEST_PATTERN_CHECKSUM (0xe95accb3)
/* 8389 add  Factory Camera auto test function end by shone 2013-12-06 */
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x32, 0x28); 
	GC0329_write_cmos_sensor(0xfe, 0x00); 
/*
...
/* d7017 update code for mirror 2013-08-29 */
    // Tiandf @ 2013-09-14  fix the issue: the face can't be detected correctly in debugree 0.
    GC0329_write_cmos_sensor(0x17, 0x14); // 14   lanking 20120423  mirror setting 
/* end by shone 2013-0-29 */
	...
	GC0329_write_cmos_sensor(0x13, 0x55);
...
BOOL GC0329_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0329_write_cmos_sensor(0x77, 0x65); //WB_manual_gain 
			GC0329_write_cmos_sensor(0x78, 0x50);
			GC0329_write_cmos_sensor(0x79, 0x65);
		break;
		...
		case AWB_MODE_DAYLIGHT: //sunny
			...
			GC0329_write_cmos_sensor(0x79, 0x75);			
		break;
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			GC0329_write_cmos_sensor(0x05, 0x00);//02 	
			GC0329_write_cmos_sensor(0x06, 0xe8); //4c
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x34);//88
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x36);//4e   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0329_write_cmos_sensor(0x2c, 0x1c); //70
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x52); 
			GC0329_write_cmos_sensor(0x2f, 0x02);   //exp level 0  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x88); 
			GC0329_write_cmos_sensor(0x31, 0x03);   //exp level 0  7.05fps
			GC0329_write_cmos_sensor(0x32, 0x96); 
			GC0329_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x55);
...
/* 8389 add  Factory Camera auto test function by shone 2013-12-06 */
UINT32 GC0329YUV_SetTestPatternMode(kal_bool bEnable)
{
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_SET_TEST_PATTERN:
        GC0329YUV_SetTestPatternMode((BOOL)*pFeatureData16);
    break;
	case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE: //for factory mode auto testing             
        *pFeatureReturnPara32= GC0329YUV_TEST_PATTERN_CHECKSUM;
        *pFeatureParaLen=4;                             
    break; 
	/* 8389 add  Factory Camera auto test function end by shone 2013-12-06 */
    default:
