...
{{
    ...
    ISPCcmPoly22:{
        ...
        22336,    // i4B_STD
        {  // i4P00[9]
            3905000, -1190000, -157500, -450000, 2650000, 362500, 240000, -1677500, 3995000
        },
        {  // i4P10[9]
            1019829, -1134268, 115260, -25571, -54920, 87126, 108317, 262160, -368923
        },
        {  // i4P01[9]
            212863, -443434, 230802, -157403, -83032, 246120, -42495, -148047, 196270
        },
        { // i4P20[9]
            0,  0,   0,  0,   0,  0, 0,  0,  0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rCCTConfig
        {
            ...
            100,    // u4PreviewFlareOffset
            100,    // u4CaptureFlareOffset
    ...
    // AWB calibration data
    {
        ...
        {// CCT estimation
            ...
            {// Rotated X coordinate
                -623,    // i4RotatedXCoordinate[0]
                -484,    // i4RotatedXCoordinate[1]
