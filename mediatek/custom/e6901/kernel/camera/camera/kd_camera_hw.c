...
u32 pinSet[2][2] = {
    ...
    if (On) {
        ...
        if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW,currSensorName)))
        {
            ...
            PK_DBG("xmcwy_camera_power ov5648_mipi_raw  on  SensorIdx = %d \n",SensorIdx);
            ...
            {
                PK_DBG("[CAMERA SENSOR] Fail to on IOVDD \n");
            ...
            {
                 PK_DBG("[CAMERA SENSOR] Fail to on DVDD \n");
                 goto _kdCISModulePowerOn_exit_;
            }
            mdelay(5);
            ...
            {
                PK_DBG("[CAMERA SENSOR] Fail to on AVDD\n");
                goto _kdCISModulePowerOn_exit_;
            }
	     mdelay(5);
            ...
            {
                PK_DBG("[CAMERA SENSOR] Fail to on AF_VCC \n");
                goto _kdCISModulePowerOn_exit_;
            }
	     mdelay(5);			
            #endif
            ...
            if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMPDN],GPIO_MODE_00)){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! \n");}
            if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMPDN],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! \n");}
            if(mt_set_gpio_out(pinSet[pinSetIdx][IDX_PS_CMPDN],GPIO_OUT_ONE)){PK_DBG("[CAMERA SENSOR] set gpio zero failed!! \n");}
            mdelay(10);            
            //RST pin
            if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_MODE_00)){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! \n");}
            if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! \n");}
            if(mt_set_gpio_out(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_OUT_ONE)){PK_DBG("[CAMERA SENSOR] set gpio one failed!! \n");}
            mdelay(10);
	        ...
	        mdelay(10);
	         ...
	         if(mt_set_gpio_mode(pinSet[1-pinSetIdx][IDX_PS_CMPDN],GPIO_MODE_00)){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! \n");}
	         if(mt_set_gpio_dir(pinSet[1-pinSetIdx][IDX_PS_CMPDN],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! \n");}	
	         if(mt_set_gpio_out(pinSet[1-pinSetIdx][IDX_PS_CMPDN],GPIO_OUT_ZERO)){PK_DBG("[CAMERA SENSOR] set gpio failed!! \n");} 
	         mdelay(10); 
	     }	
            //RST pin	 
	 ...
	 PK_DBG("xmcwy_camera_power ov5648_mipi_raw  off  SensorIdx = %d \n",SensorIdx);
	 ...
	 //AF_VCC
        ...
        {
            PK_DBG("[CAMERA SENSOR] Fail to off AF_VCC \n");
            goto _kdCISModulePowerOn_exit_;
        }
