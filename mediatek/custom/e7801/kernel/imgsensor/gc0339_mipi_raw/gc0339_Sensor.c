...
UINT32 GC0339GetSensorID(UINT32 *sensorID) 
{
 ...
 s_DEVINFO_ccm =(struct devinfo_struct*) kmalloc(sizeof(struct devinfo_struct), GFP_KERNEL);	
	...
	s_DEVINFO_ccm->device_module = "G5PV-W8666FHQ";//can change if got module id
	s_DEVINFO_ccm->device_vendor = "HUAQUAN";
	s_DEVINFO_ccm->device_ic = "GC0339";
