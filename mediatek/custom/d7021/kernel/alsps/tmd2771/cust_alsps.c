...
static struct alsps_hw cust_alsps_hw = {
    ...
    .als_level  = { 1, 10,  20,   50,  100, 150,  200, 300, 500,  1000, 2000, 3000, 5000, 8000, 10000},
    .als_value  = {5, 70,  70,  120, 120, 120,  500,  500, 500,  10240,  10240,  10240,  10240, 10240,  10240, 10240},
