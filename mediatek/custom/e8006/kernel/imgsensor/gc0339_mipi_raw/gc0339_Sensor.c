...
static GC0339_sensor_struct GC0339_sensor =
{
	...
	.Mirror = GC0339_IMAGE_NORMAL,//GC0339_IMAGE_V_MIRROR,//GC0339_IMAGE_H_MIRROR,
	.shutter = 0x20,  
	.gain = 0x20,
...
void GC0339_SetMirrorFlip(GC0339_IMAGE_MIRROR Mirror)
{
	switch(Mirror)
	{
		case GC0339_IMAGE_NORMAL://IMAGE_V_MIRROR:
		   GC0339_write_cmos_sensor(0x14,0x10);
		    break;
		case GC0339_IMAGE_H_MIRROR://IMAGE_NORMAL:
		   GC0339_write_cmos_sensor(0x14,0x01);
		    break;
		case GC0339_IMAGE_V_MIRROR://IMAGE_HV_MIRROR:
		   GC0339_write_cmos_sensor(0x14,0x32);
		    break;
...
static void GC0339_Sensor_Init(void)
{
	...
	GC0339_write_cmos_sensor(0x1b,0x08);
	GC0339_write_cmos_sensor(0x1c,0x19);
    GC0339_write_cmos_sensor(0x1d,0xea);
	
	GC0339_write_cmos_sensor(0x61,0x2b);
	GC0339_write_cmos_sensor(0x62,0x2e);
	GC0339_write_cmos_sensor(0x63,0x03);
	GC0339_write_cmos_sensor(0x30,0xb7);
	GC0339_write_cmos_sensor(0x31,0x7f);
	
	GC0339_write_cmos_sensor(0x32,0x00);
    GC0339_write_cmos_sensor(0x39,0x04);
	GC0339_write_cmos_sensor(0x3a,0x20);
	GC0339_write_cmos_sensor(0x3b,0x20);
	GC0339_write_cmos_sensor(0x3c,0x04);
	GC0339_write_cmos_sensor(0x3d,0x04);
	GC0339_write_cmos_sensor(0x3e,0x04);
	GC0339_write_cmos_sensor(0x3f,0x04);
	GC0339_write_cmos_sensor(0x69,0x03);

	GC0339_write_cmos_sensor(0x60,0x82);
	...
	GC0339_write_cmos_sensor(0x60,0x92);
}   /*  GC0339_Sensor_Init  */
...
SENSORDB("GC0339Open GC0339_Sensor_Init start... \n");	
	/* initail sequence write in  */
	GC0339_Sensor_Init();
SENSORDB("GC0339Open GC0339_Sensor_Init end... \n");	
...
SENSORDB("GC0339FeatureControl start \n");
