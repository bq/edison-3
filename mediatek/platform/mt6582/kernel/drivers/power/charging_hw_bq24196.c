...
/*Added modified@by xmyyq 2014-05-05*/
#if defined(MALATA_E8001)
	bq24196_set_vindpm(0x6); //VIN DPM check 4.36V
#else
 ...
 static kal_uint32 charging_enable(void *data)
 {
	...
	else
	{
...
#endif 			
    	{
			...
			/*add ce test config by xmyyq,20140506*/
...
//extern CHARGER_TYPE hw_charger_type_detection(void);
 ...
 static kal_uint32 charging_get_charger_type(void *data)
 {
    ...
    if(g_charger_type!=CHARGER_UNKNOWN && g_charger_type!=WIRELESS_CHARGER && g_charger_type!=NONSTANDARD_CHARGER && g_charger_type!=APPLE_0_5A_CHARGER)
    {
