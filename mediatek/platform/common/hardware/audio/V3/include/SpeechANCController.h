...
class SpeechANCController
{
    public:
        ...
        status_t OpenFile(FILE *mDumpFile, int mType_ANC);
#endif
    ...
    private:
        ...
        bool mApply;
        bool mGroupANC;
        bool mEnable_ANCLog1, mEnable_ANCLog2, mEnable_ANCLog3, mEnable_ANCLog4, mEnable_ANCLog5;
         ...
         * pcm read thread
         */
        static void *readThread_ANCLog1(void *arg);
        static void *readThread_ANCLog2(void *arg);
        static void *readThread_ANCLog3(void *arg);
        static void *readThread_ANCLog4(void *arg);
        static void *readThread_ANCLog5(void *arg);
        pthread_t hReadThread_ANCLog1, hReadThread_ANCLog2, hReadThread_ANCLog3, hReadThread_ANCLog4, hReadThread_ANCLog5;
