...
#if 0  //def MT8127_DDR3_X8
//PCDDR3X8
unsigned char Bit_DQO_Mapping[32] = 
{
    23, 18, 20, 16, 21, 19, 22, 17, //Bit0~7
    29, 26, 30, 27, 31, 24, 28, 25, //Bit8~15
    10, 14, 8,  15, 11, 13, 9,  12, //Bit16~23
    2,  5,  0,  7,  1,  6,  3,  4   //Bit24~31
};
unsigned char DQSO_Mapping[4] = {2, 3, 1, 0}; 	// This could be by DQSx for CPU/CMP_ERR bit 0~7, bit 8~15, bit 16~23, bit 24~31
unsigned char DQM_Mapping[4] = {2, 3, 1, 0};
#endif
