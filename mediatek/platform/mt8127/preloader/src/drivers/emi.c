...
//		  *((V_UINT32P)(EMI_BASE   +0x0078))=0x23110003;// ???????????0x00030F4d;
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x0048)) = 0x0001110d;
	...
	//For MT8127 LPDDR3
	*((V_UINT32P)(DRAMC0_BASE + 0x00d8)) = 0x80500900; //Edward: 100b for LPDDR2/3, 110b for DDR3x16x2
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x0168)) = 0x00000080;
	...
	//*((V_UINT32P)(DDRPHY_BASE + 0x00d8)) = 0x00700900;
	//For MT8127 LPDDR3
	*((V_UINT32P)(DRAMC0_BASE + 0x00d8)) = 0x80700900;	 // Edward : 100b for LPDDR2/3, 110b for DDR3x16x2
	...
	*((V_UINT32P)(DRAMC0_BASE + 0x01e0)) = 0x2000ffff;	  //LPDDR2EN set to 0
	*((V_UINT32P)(DDRPHY_BASE + 0x01e0)) = 0x2000ffff;	  //LPDDR2EN set to 0
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x00e4)) = 0x00000005;	 //CKEBYCTL
	...
	ASM_DSB;	// Edward : add this according to 6589.
	gpt_busy_wait_us(200);//Wait > 200us			  // Edward : add this according to 6589.

	*((V_UINT32P)(DRAMC0_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_63;
	*((V_UINT32P)(DDRPHY_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_63;
	...
	*((V_UINT32P)(DRAMC0_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_10;
	*((V_UINT32P)(DDRPHY_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_10;
	...
	*((V_UINT32P)(DRAMC0_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_1;
	*((V_UINT32P)(DDRPHY_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_1;
	...
	*((V_UINT32P)(DRAMC0_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_2;
	*((V_UINT32P)(DDRPHY_BASE + 0x0088)) = emi_setting->ddr_mode.lpddr3.LPDDR3_MODE_REG_2;
...
#ifdef DDR3_16B
    *(volatile unsigned int *)(DRAMC0_BASE + 0x00F0) = 0x40008000;   //pinmux2=1   // Edward: DQ4BMUX[31]=1  [30]S2=1,
    *(volatile unsigned int *)(DDRPHY_BASE + 0x00F0) = 0x40008000;   //pinmux2=1
#else
    //[20131203]QW: update pinmux setting, bit.31 must is 0 for mt8127
    *(volatile unsigned int *)(DRAMC0_BASE + 0x00F0) = 0x40008000;   //PINMUX2 ==> 1 // Edward: DQ4BMUX[31]=1  [30]S2=1,
    *(volatile unsigned int *)(DDRPHY_BASE + 0x00F0) = 0x40008000;
...
#define Vcore_HV_LPPDR3 (0x50)  //1.2V; 1010000: 1.20000V
#define Vcore_NV_LPPDR3 (0x44)  //1.125V; 1000100: 1.12500V
#define Vcore_LV_LPPDR3 (0x30)  //1.0V; 0110000: 1.00000V
