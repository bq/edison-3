...
#define WRAP_DEW_EVENT_OUT_EN   (DEW_BASE+0x0)
#define WRAP_DEW_DIO_EN         (DEW_BASE+0x2)
#define WRAP_DEW_EVENT_SRC_EN   (DEW_BASE+0x4)
#define WRAP_DEW_EVENT_SRC      (DEW_BASE+0x6)
#define WRAP_DEW_EVENT_FLAG     (DEW_BASE+0x8)
#define WRAP_DEW_READ_TEST      (DEW_BASE+0xA)
#define WRAP_DEW_WRITE_TEST     (DEW_BASE+0xC)
#define WRAP_DEW_CRC_EN         (DEW_BASE+0xE)
#define WRAP_DEW_CRC_VAL        (DEW_BASE+0x10)
#define WRAP_DEW_MON_GRP_SEL    (DEW_BASE+0x12)
#define WRAP_DEW_MON_FLAG_SEL   (DEW_BASE+0x14)
#define WRAP_DEW_EVENT_TEST     (DEW_BASE+0x16)
#define WRAP_DEW_CIPHER_KEY_SEL (DEW_BASE+0x18)
#define WRAP_DEW_CIPHER_IV_SEL  (DEW_BASE+0x1A)
#define WRAP_DEW_CIPHER_LOAD    (DEW_BASE+0x1C)
#define WRAP_DEW_CIPHER_START   (DEW_BASE+0x1E)
#define WRAP_DEW_CIPHER_RDY     (DEW_BASE+0x20)
#define WRAP_DEW_CIPHER_MODE    (DEW_BASE+0x22)
#define WRAP_DEW_CIPHER_SWRST   (DEW_BASE+0x24)
#define WRAP_DEW_CIPHER_IV0     (DEW_BASE+0x26)
#define WRAP_DEW_CIPHER_IV1     (DEW_BASE+0x28)
#define WRAP_DEW_CIPHER_IV2     (DEW_BASE+0x2A)
#define WRAP_DEW_CIPHER_IV3     (DEW_BASE+0x2C)
#define WRAP_DEW_CIPHER_IV4     (DEW_BASE+0x2E)
#define WRAP_DEW_CIPHER_IV5     (DEW_BASE+0x30)
#else
