...
extern int mmc_block_read(int dev_num, unsigned long blknr, u32 blkcnt, void *dst, u32 part_id);
extern int mmc_block_write(int dev_num, unsigned long blknr, u32 blkcnt, const void *src, u32 part_id);
...
extern int sd_legacy_init(int verbose);
#endif
#ifdef __cplusplus
}
#endif
