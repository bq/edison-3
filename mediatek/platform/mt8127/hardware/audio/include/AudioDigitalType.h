...
class AudioDigitalType
{
    public:
        ...
        enum HdmiInterConnectionInput
        {
            ...
            I26,
            I27,
            HDMI_CONN_INPUT_BASE = I20,
            HDMI_CONN_INPUT_MAX  = I27,
            NUM_HDMI_INPUT = (HDMI_CONN_INPUT_MAX - HDMI_CONN_INPUT_BASE + 1)
        };

        enum HdmiInterConnectionOutput
        {
            O20 = 20,
            O21,
            O22,
            ...
            O28,
            O29,
            HDMI_CONN_OUTPUT_BASE = O20,
            HDMI_CONN_OUTPUT_MAX = O29,
            NUM_HDMI_OUTPUT = (HDMI_CONN_OUTPUT_MAX - HDMI_CONN_OUTPUT_BASE + 1)
        };
