...
android_audio_legacy::AudioStreamOut *AudioMTKHardware::openOutputStreamWithFlag(
    uint32_t devices,
    int *format,
    uint32_t *channels,
    uint32_t *sampleRate,
...
{
    return mAudioMTKStreamManager->openOutputStream(devices, format, channels, sampleRate, status, output_flag);
}
