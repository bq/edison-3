...
status_t AudioAnalogControl::AnalogOpenForAddSPK(AudioAnalogType::DEVICE_TYPE DeviceType, AudioAnalogType::DEVICE_TYPE_SETTING Type_setting)
{
    ...
    {
        ALOGD("AnalogOpenForAddSPK DeviceType = %s", kAudioAnalogDeviceTypeName[DeviceType]);
        mAudioMachineDevice->AnalogClose(AudioAnalogType::DEVICE_OUT_HEADSETR);
        mAudioPlatformDevice->AnalogClose(AudioAnalogType::DEVICE_OUT_HEADSETR);
        mAudioPlatformDevice->AnalogOpen(AudioAnalogType::DEVICE_OUT_SPEAKER_HEADSET_R);        
        mAudioMachineDevice->AnalogOpen(AudioAnalogType::DEVICE_OUT_SPEAKER_HEADSET_R);
    }    
...
status_t AudioAnalogControl::AnalogCloseForSubSPK(AudioAnalogType::DEVICE_TYPE DeviceType, AudioAnalogType::DEVICE_TYPE_SETTING Type_setting)
{
    ...
    {
        ALOGD("AnalogOpenForAddSPK DeviceType = %s", kAudioAnalogDeviceTypeName[DeviceType]);
        mAudioMachineDevice->AnalogClose(AudioAnalogType::DEVICE_OUT_SPEAKER_HEADSET_R);
        mAudioPlatformDevice->AnalogClose(AudioAnalogType::DEVICE_OUT_SPEAKER_HEADSET_R);
        mAudioPlatformDevice->AnalogOpen(AudioAnalogType::DEVICE_OUT_HEADSETR);        
        mAudioMachineDevice->AnalogOpen(AudioAnalogType::DEVICE_OUT_HEADSETR);        
    }    
