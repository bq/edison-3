...
#if defined (MALATA_E1003)//[A]begin xmlnb 20140623 fix:at first time opening camera, camera show abnormal bug_id:25104
// do nothing 
#else
#if 1 //enable smooth
...
#endif
#endif //[A]end xmlnb 20140623 fix:at first time opening camera, camera show abnormal bug_id:25104
