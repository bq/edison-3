...
MINT32 Hal3AYuv::mapAEToEnum(MINT32 mval,MFLOAT mstep)
{
    ...
    if     (pEv <-250)
    {
        ret = AE_EV_COMP_n30;   // EV compensate -3.0
    }
    else if (pEv <-200)
    {
        ret = AE_EV_COMP_n25;   // EV compensate -2.5
    }
    else if (pEv <-170)
    {
        ret = AE_EV_COMP_n20;   // EV compensate -2.0
    }
    else if (pEv <-160)
    {
        ret = AE_EV_COMP_n17;   // EV compensate -1.7
    }
    else if (pEv <-140)
    {
        ret = AE_EV_COMP_n15;   // EV compensate -1.5
    }
    else if (pEv <-130)
    {
        ret = AE_EV_COMP_n13;   // EV compensate -1.3
    }
    else if (pEv < -90)
    {
        ret = AE_EV_COMP_n10;   // EV compensate -1.0
    }
    else if (pEv < -60)
    {
        ret = AE_EV_COMP_n07;   // EV compensate -0.7
    }
    else if (pEv < -40)
    {
        ret = AE_EV_COMP_n05;   // EV compensate -0.5
    }
    else if (pEv < -10)
    {
        ret = AE_EV_COMP_n03;   // EV compensate -0.3
    }
    else if (pEv ==  0)
    {
        ret = AE_EV_COMP_00;    // EV compensate -2.5
    }
    else if (pEv <  40)
    {
        ret = AE_EV_COMP_03;    // EV compensate  0.3
    }
    else if (pEv <  60)
    {
        ret = AE_EV_COMP_05;    // EV compensate  0.5
    }
    else if (pEv <  90)
    {
        ret = AE_EV_COMP_07;    // EV compensate  0.7
    }
    else if (pEv < 110)
    {
        ret = AE_EV_COMP_10;    // EV compensate  1.0
    }
    else if (pEv < 140)
    {
        ret = AE_EV_COMP_13;    // EV compensate  1.3
    }
    else if (pEv < 160)
    {
        ret = AE_EV_COMP_15;    // EV compensate  1.5
    }
    else if (pEv < 180)
    {
        ret = AE_EV_COMP_17;    // EV compensate  1.7
    }
    else if (pEv < 210)
    {
        ret = AE_EV_COMP_20;    // EV compensate  2.0
    }
    else if (pEv < 260)
    {
        ret = AE_EV_COMP_25;    // EV compensate  2.5
    }
    else if (pEv < 310)
    {
        ret = AE_EV_COMP_30;    // EV compensate  3.0
    }
    else
    {
        ret = AE_EV_COMP_00;
