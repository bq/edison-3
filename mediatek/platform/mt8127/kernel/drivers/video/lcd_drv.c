...
{
// bypass this wait for reasons as below:
// 1. tablet do not need DBI interface
// 2. LCD_BASE(0xF4012000) equal to RDMA1(8127 RDMA1, 6582 has not RDMA1), so maybe affect HDMI path.
#if 0
#if ENABLE_LCD_INTERRUPT
