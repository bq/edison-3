...
#define ENABLE_CEC_IRQ() 	(hdmi_write(0x1500,0x20))//(mt_set_gpio_pull_select(GPIO60,  GPIO_PULL_UP))
#define DISABLE_CEC_IRQ()	(hdmi_write(0x1500,0x0))//(mt_set_gpio_pull_select(GPIO60,  ~GPIO_PULL_UP))
#define CLR_CEC_IRQ() 	    (hdmi_write(0x1504,0x20))//(mt65xx_eint_unmask(13))
...
static unsigned char _fgUICECEnable = 0;
