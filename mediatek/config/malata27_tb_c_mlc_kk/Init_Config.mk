...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      ...
                      $(MTK_ROOT_CONFIG_OUT)/init.fon.merge.rc:root/init.fon.merge.rc \
...
ifeq ($(strip $(MTK_RAWFS_NAND_SUPPORT)),yes)
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/init.protect.rawfs.rc:root/init.protect.rawfs.rc
endif
