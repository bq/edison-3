...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME=MALATA_E1003 HDMI_VOLUME_ADJUST_SUPPORT MTK_ACMT_DEBUG MTK_BT_PROFILE_AVRCP MTK_NVRAM_SECURITY MTK_MMPROFILE_SUPPORT MTK_GPS_SUPPORT MTK_3GDONGLE_SUPPORT MTK_MPEG_DASH_SUPPORT MTK_CAM_AUTORAMA_SUPPORT EVDO_DT_SUPPORT MTK_CAMCORDER_PROFILE_MID_MP4 MTK_CAM_MAV_SUPPORT CUSTOM_KERNEL_MAGNETOMETER MTK_FM_SUPPORT MTK_USES_HD_VIDEO MTK_TABLET_PLATFORM MTK_DRM_APP MTK_MT8193_NFI_SUPPORT MTK_VIDEO_VP9_SUPPORT MTK_VIDEO_AUTO_FLASH_SUPPORT MTK_AUTO_DETECT_MAGNETOMETER MTK_SMARTBOOK_SUPPORT MTK_GEMINI_SMART_3G_SWITCH MTK_AUDIO_APE_SUPPORT MTK_BT_PROFILE_MANAGER MTK_SIM_RECOVERY MTK_TER_SERVICE MTK_FM_RECORDING_SUPPORT MTK_AUDIO_EXTCODEC_SUPPORT MTK_CAM_STEREO_CAMERA_SUPPORT PURE_AP_USE_EXTERNAL_MODEM MTK_DEDICATEDAPN_SUPPORT MTK_WAPI_SUPPORT MTK_BT_PROFILE_HIDH MTK_BT_PROFILE_TIMES MTK_PASSPOINT_R2_SUPPORT MTK_BT_PROFILE_BIP MTK_CAMERA_BSP_SUPPORT MTK_USER_ROOT_SWITCH MTK_MATV_SERIAL_IF_SUPPORT MTK_MULTIBRIDGE_SUPPORT MTK_BT_PROFILE_PBAP MTK_FAT_ON_NAND MTK_DOLBY_DAP_SUPPORT MTK_DX_HDCP_SUPPORT MTK_GEMINI_4SIM_SUPPORT MTK_YAML_SCATTER_FILE_SUPPORT MTK_CAM_IMAGE_REFOCUS_SUPPORT MTK_BT_PROFILE_PAN MTK_BT_PROFILE_HFP MTK_BT_21_SUPPORT MTK_CAM_GESTURE_SUPPORT CUSTOM_KERNEL_BAROMETER MTK_BT_PROFILE_AVRCP14 MTK_BOX_AUDIO_DDPLUS_SUPPORT MTK_MASS_STORAGE MTK_RAWFS_NAND_SUPPORT MTK_BICR_SUPPORT MTK_MDM_LAWMO MTK_SEC_VIDEO_PATH_SUPPORT MTK_CAM_VIDEO_FACEBEAUTY_SUPPORT MTK_WMA_PLAYBACK_SUPPORT MTK_FM_50KHZ_SUPPORT MTK_BT_PROFILE_BPP MTK_CTPPPOE_SUPPORT MTK_COMBO_QUICK_SLEEP_SUPPORT MTK_THEMEMANAGER_APP MTK_FSCK_TUNE MTK_TMP103_SUPPORT MTK_MLC_NAND_SUPPORT MTK_TABLET_DRAM MTK_CAMERA_APP_3DHW_SUPPORT MTK_MT8193_SUPPORT MTK_MERGE_INTERFACE_SUPPORT HAVE_AACENCODE_FEATURE MTK_BT_PROFILE_MAPS TRUSTONIC_TEE_SUPPORT MTK_AUDIO MTK_WIFI_HOTSPOT_SUPPORT MTK_COMBO_SUPPORT MTK_CSD_DIALER_SUPPORT MTK_IN_HOUSE_TEE_SUPPORT MTK_FLIGHT_MODE_POWER_OFF_MD MTK_RADIOOFF_POWER_OFF_MD MTK_PRIVACY_PROTECTION_LOCK MTK_BT_PROFILE_MAPC MTK_SHARED_SDCARD MTK_EMMC_DISCARD MTK_PQ_SUPPORT MTK_DSPIRDBG MTK_WVDRM_L1_SUPPORT MTK_VT3G324M_SUPPORT MTK_VIDEO_HEVC_SUPPORT MTK_DMNR_TUNING_AT_MD MTK_MULTI_STORAGE_SUPPORT MTK_CACHE_MERGE_SUPPORT MTK_MT8193_HDCP_SUPPORT MTK_ENABLE_VIDEO_EDITOR MTK_CHIPTEST_INT MTK_EAP_SIM_AKA MTK_BQ24156_SUPPORT MTK_WFD_SUPPORT MTK_DUAL_MIC_SUPPORT MTK_HIGH_RESOLUTION_AUDIO_SUPPORT MTK_BATLOWV_NO_PANEL_ON_EARLY MTK_CAM_HDR_SUPPORT MTK_WIFIWPSP2P_NFC_SUPPORT MTK_FD_SUPPORT MTK_DISPLAY_HIGH_RESOLUTION HAVE_ADPCMENCODE_FEATURE MTK_OGM_PLAYBACK_SUPPORT MTK_NCP1851_SUPPORT HAVE_AWBENCODE_FEATURE MTK_CAM_LOMO_SUPPORT NAND_OTP_SUPPORT MTK_BQ24196_SUPPORT MTK_FACEBEAUTY_SUPPORT MTK_PERSIST_PARTITION_SUPPORT MTK_AAL_SUPPORT MTK_BESLOUDNESS_SUPPORT MTK_LTE_DC_SUPPORT MTK_FAN5405_SUPPORT MTK_CAM_SD_SUPPORT MTK_MT8193_HDMI_SUPPORT MTK_WFD_SINK_UIBC_SUPPORT MTK_AUDIO_HD_REC_SUPPORT MTK_BQ24296_SUPPORT MTK_PUMP_EXPRESS_SUPPORT MTK_CAMERA_OT_SUPPORT MTK_PASSPOINT_R1_SUPPORT MTK_BQ24158_SUPPORT MTK_CAM_FD_SUPPORT MTK_SLOW_MOTION_VIDEO_SUPPORT MTK_AVI_PLAYBACK_SUPPORT MTK_BT_PROFILE_FTP MTK_BATTERY_PROTECT MTK_TOUCH_BOOST MTK_USES_VR_DYNAMIC_QUALITY_MECHANISM MTK_HIGH_QUALITY_THUMBNAIL MTK_FAN5402_SUPPORT MTK_IPV6_TETHER_NDP_MODE MTK_FLV_PLAYBACK_SUPPORT MTK_WIRELESS_CHARGER_SUPPORT MTK_PLAYREADY_SUPPORT MTK_IMAGE_LARGE_MEM_LIMIT MTK_SUBTITLE_SUPPORT IS_VRF18_USE_6333VRF18 MTK_FM_TX_SUPPORT MTK_MDM_FUMO MTK_OWNER_SDCARD_ONLY_SUPPORT MTK_BRAZIL_CUSTOMIZATION_VIVO MTK_BRAZIL_CUSTOMIZATION_CLARO MT6280_SUPER_DONGLE MTK_ENABLE_MD5 MTK_ENABLE_MD2 MTK_SWIP_WMAPRO MTK_CAM_OT_SUPPORT MTK_ENABLE_MD1 MTK_SEC_WFD_VIDEO_PATH_SUPPORT MTK_ALPS_BOX_SUPPORT MTK_LCA_RAM_OPTIMIZE MTK_VOICE_UI_SUPPORT MTK_WORLD_PHONE MTK_CAM_FACEBEAUTY_SUPPORT MTK_NO_NEED_USB_LED MTK_CAM_DEPTH_AF_SUPPORT MTK_BT_40_SUPPORT EVDO_DT_VIA_SUPPORT MTK_COMBO_NAND_SUPPORT MTK_AUTORAMA_SUPPORT MTK_CAM_SINGLE_3DSHOT_SUPPORT MTK_BT_PROFILE_TIMEC MTK_VOICE_UNLOCK_SUPPORT MTK_CAM_EIS_SUPPORT MTK_UMTS_TDD128_MODE MTK_TETHERING_EEM_SUPPORT MTK_YMAL_SCATTER_FILE_SUPPORT MTK_MATV_ANALOG_SUPPORT MTK_IPTV_SUPPORT MTK_NEW_COMBO_EMMC_SUPPORT MTK_OD_SUPPORT MTK_MOBILE_MANAGEMENT MTK_MOTION_TRACK_SUPPORT MTK_BRAZIL_CUSTOMIZATION MTK_BT_PROFILE_A2DP MTK_PLAYBACK_60FPS_TO_30FPS MTK_LCA_ROM_OPTIMIZE MTK_TABLET_PLUGIN_BUILD MTK_WFD_HDCP_TX_SUPPORT MTK_BT_SUPPORT MTK_ASF_PLAYBACK_SUPPORT MTK_DFO_RESOLUTION_SUPPORT MTK_SPI_NAND_SUPPORT MTK_CTA_SUPPORT MTK_PM_STATS_SUPPORT MTK_BEAM_PLUS_SUPPORT MTK_PARTITION_TABLE_PLAIN_TEXT MTK_CAM_NR3D_SUPPORT MTK_THERMAL_PA_VIA_ATCMD MTK_IPV6_SUPPORT MTK_EXTERNAL_DONGLE_SUPPORT MTK_CAM_VHDR_SUPPORT MTK_NFC_SUPPORT MTK_PMIC_MT6397 MTK_GPT_SCHEME_SUPPORT MTK_SDIOAUTOK_SUPPORT MTK_NAND_UBIFS_SUPPORT CUSTOM_KERNEL_GYROSCOPE MTK_MDM_SCOMO MTK_SIM_HOT_SWAP_COMMON_SLOT MTK_AUDIO_DDPLUS_SUPPORT MTK_HANDSFREE_DMNR_SUPPORT MTK_EMULATOR_SUPPORT CUSTOM_KERNEL_ACCELEROMETER TELEPHONY_DFOSET MTK_MT6333_SUPPORT MTK_LOMO_SUPPORT MTK_PRODUCT_INFO_SUPPORT MTK_POWER_EXT_DETECT MTK_WLAN_SUPPORT CUSTOMER_BQ MTK_POST_PROCESS_FRAMEWORK_SUPPORT MTK_DRM_PLAYREADY_SUPPORT MTK_TETHERINGIPV6_SUPPORT MTK_WMV_PLAYBACK_SUPPORT MTK_BIP_SCWS MTK_UART_USB_SWITCH MTK_IPOH_SUPPORT MTK_VOW_SUPPORT MTK_AUTO_DETECT_ACCELEROMETER HAVE_CMMB_FEATURE MTK_DT_SUPPORT MTK_EMMC_SUPPORT_OTP IS_VCORE_USE_6333VCORE MTK_TB_APP_CALL_FORCE_SPEAKER_ON HAVE_MATV_FEATURE MTK_COMBO_CORE_DUMP_SUPPORT MTK_PLATFORM_OPTIMIZE MTK_SWCHR_SUPPORT MTK_BQ24157_SUPPORT MTK_MULTISIM_RINGTONE_SUPPORT MTK_FORCE_CLUSTER1 MTK_FEMTO_CELL_SUPPORT MTK_AUDIO_RAW_SUPPORT MTK_FM_RX_SUPPORT MTK_FM_SHORT_ANTENNA_SUPPORT MTK_QVGA_LANDSCAPE_SUPPORT MTK_AIV_SUPPORT MTK_AUTO_DETECT_ALSPS MTK_HDMI_HDCP_SUPPORT MTK_HDMI_SUPPORT MTK_GEMINI_3SIM_SUPPORT MTK_INTERNAL_HDMI_SUPPORT IS_VM_USE_6333VM MTK_BT_PROFILE_SPP MTK_KERNEL_POWER_OFF_CHARGING MTK_BQ24160_SUPPORT MTK_AUDIO_ADPCM_SUPPORT MTK_DVFS_DISABLE_LOW_VOLTAGE_SUPPORT MTK_CAM_ZSD_SUPPORT MTK_IMS_SUPPORT MTK_DISABLE_POWER_ON_OFF_VOLTAGE_LIMITATION MTK_HW_ENHANCE USE_FRAUNHOFER_AAC MTK_ION_SUPPORT MTK_SHOW_MSENSOR_TOAST_SUPPORT MTK_LCEEFT_SUPPORT MTK_CTP_RESET_CONFIG MTK_BT_FM_OVER_BT_VIA_CONTROLLER MTK_AUDIO_CHANGE_SUPPORT MTK_VOIP_ENHANCEMENT_SUPPORT MTK_LCA_SUPPORT MTK_DHCPV6C_WIFI MTK_WIFI_CALLING_RIL_SUPPORT MTK_BT_PROFILE_PRXM MTK_MTKPS_PLAYBACK_SUPPORT MTK_FSCK_MSDOS_MTK MTK_LIVE_PHOTO_SUPPORT MTK_IPV6_TETHER_PD_MODE MTK_2IN1_SPK_SUPPORT MTK_EXTERNAL_LDO MTK_BT_PROFILE_DUN MTK_SWIP_VORBIS MTK_MD_SHUT_DOWN_NT CUSTOM_KERNEL_ALSPS MTK_SPH_EHN_CTRL_SUPPORT MTK_BSP_PACKAGE MTK_WB_SPEECH_SUPPORT MTK_2SDCARD_SWAP MTK_VOLTE_SUPPORT MTK_VIBSPK_SUPPORT HW_HAVE_TP_THREAD MTK_CLEARMOTION_SUPPORT MTK_BT_PROFILE_PRXR MTK_BQ27541_SUPPORT ENCRY_PARTITION_SUPPORT MTK_CAM_NATIVE_PIP_SUPPORT MTK_BT_30_SUPPORT MTK_DRM_KEY_MNG_SUPPORT MTK_DFO_SUPPORT MTK_WFD_SINK_SUPPORT MTK_MAV_SUPPORT MTK_ETHERNET_SUPPORT MTK_SD_REINIT_SUPPORT MTK_CAM_ASD_SUPPORT MTK_SENSOR_SUPPORT MTK_M4U_SUPPORT MTK_BT_PROFILE_OPP MTK_EMMC_SUPPORT MTK_MULTI_PARTITION_MOUNT_ONLY_SUPPORT MTK_INTERNAL_MHL_SUPPORT MTK_BT_PROFILE_SIMAP MTK_BQ24297_SUPPORT MTK_CAM_VSS_SUPPORT MTK_LTE_SUPPORT MTK_WEB_NOTIFICATION_SUPPORT MTK_TC1_FEATURE HAVE_XLOG_FEATURE MTK_WLANBT_SINGLEANT MTK_MSDC1_NOT_SUPPORT_SDR104 MTK_VOICE_CONTACT_SEARCH_SUPPORT BATTERY_THERMAL_CHECK_POWER_ON
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE=MTK_TELEPHONY_BOOTUP_MODE_SLOT2 MTK_TELEPHONY_BOOTUP_MODE_SLOT1 MTK_CAM_MFB_SUPPORT MTK_SHARE_MODEM_SUPPORT MTK_CAM_CONTINUOUS_SHOT_MODE LCM_WIDTH MTK_HOTKNOT_SUPPORT MTK_FW_UPGRADE MTK_NEON_SUPPORT MTK_COMBO_PSM_TX_TH MTK_NFC_SE_NUM MTK_COMBO_PSM_RX_TH MTK_PCB_BATTERY_SENSOR MTK_SHARE_MODEM_CURRENT MTK_VIDEO_4KH264_SUPPORT MTK_SIM2_SOCKET_TYPE MTK_SIM1_SOCKET_TYPE MTK_LCM_PHYSICAL_ROTATION LCM_HEIGHT MTK_FW_UPGRADE_APP MTK_ICUSB_SUPPORT MTK_OVERLAY_ENGINE_SUPPORT CUSTOM_KERNEL_SSW MTK_SINGLE_3DSHOT_SUPPORT MTK_EXTERNAL_MODEM_SLOT CUSTOM_KERNEL_MAIN2_IMGSENSOR CUSTOM_KERNEL_KPD_MHALL
...
CUSTOM_HAL_IMGSENSOR=ov5693_mipi_raw ov5694_mipi_raw gc2235_raw

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=fm50af ov5694af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR=
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=ov5694_mipi_raw

# lens driver config for main camera (2nd solution)
CUSTOM_HAL_MAIN_BACKUP_LENS= ov5694af
...
CUSTOM_HAL_MAIN_IMGSENSOR=ov5693_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR=ov5693_mipi_raw ov5694_mipi_raw gc2235_raw

# key pad driver to report key event
CUSTOM_KERNEL_KPD=kpd
CUSTOM_KERNEL_KPD_MHALL=no

# leds driver including green/red/blue
CUSTOM_KERNEL_LEDS=mt65xx

# same as CUSTOM_HAL_LENS
CUSTOM_KERNEL_LENS=fm50af ov5694af dummy_lens
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=ov5694_mipi_raw

# lens driver config for main camera (2nd solution)
CUSTOM_KERNEL_MAIN_BACKUP_LENS=ov5694af

# Kernel space image sensor driver:Main camera (rear camera) used sensor driver.Value is used main sensor name.
CUSTOM_KERNEL_MAIN_IMGSENSOR=ov5693_mipi_raw
...
CUSTOM_KERNEL_SOUND=amp_aw8736_spk_amp_6323pmic_hp
...
CUSTOM_KERNEL_TOUCHPANEL=GT9XX ft5606
...
# yes to enable HDMI volume adjust support
HDMI_VOLUME_ADJUST_SUPPORT=yes
...
BOOT_LOGO=bq_edison3

# To choose kernel LCM driver name
CUSTOM_KERNEL_LCM=EE101IA

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=EE101IA
...
MTK_PRODUCT_LOCALES=en_GB es_ES en_US fr_CA fr_CH fr_BE fr_FR it_CH it_IT de_AT de_CH de_DE de_LI nl_BE nl_NL cs_CZ pl_PL ja_JP zh_TW zh_CN ru_RU ko_KR nb_NO es_US da_DK el_GR tr_TR pt_PT pt_BR rm_CH sv_SE bg_BG ca_ES en_AU en_CA en_NZ en_SG fi_FI hi_IN hr_HR hu_HU in_ID iw_IL lt_LT lv_LV ro_RO sk_SK sl_SI sr_RS uk_UA vi_VN tl_PH ar_EG fa_IR th_TH sw_TZ ms_MY af_ZA zu_ZA am_ET hi_IN
...
#CREATE_PROJECT_INFO=2014042522230
MTK_BUILD_VERNO = ALPS.KK1.MP10.V1.6
MALATA_E1003 = yes
# for app and framework switch project
CUSTOMER_BQ=yes
#battery thermal check power on below 45C
BATTERY_THERMAL_CHECK_POWER_ON = yes
