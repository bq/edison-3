...
#if defined(CUSTOMER_BQ) && defined(MALATA_E1003)
#define PRODUCT_STRING "Edison 3"
#else
...
static void android_work(struct work_struct *data)
{
    ...
    #ifdef MTK_ALPS_BOX_SUPPORT    //8127 box no charger IC to detect the USB CABLE, so need default set connect.
        is_hwconnected = true;
    #endif
