...
#if defined(CUSTOMER_QMOBILE)
#if defined(MALATA_E7006)
#define PRODUCT_STRING "QTab V6"
#elif  defined(MALATA_E7007)
#define PRODUCT_STRING "QTab V8"
#else //  defined(MALATA_E7801)
#define PRODUCT_STRING "QTab V10"
#endif
#else
