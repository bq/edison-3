...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    /*[A] modify X dpi and Y dpi, xmwyq, 20150715 */
		params->physical_width = 216;
		params->physical_height = 135;
		/*End xmwyq, 20150715 */
