...
#define GPIO_LCD_RST			GPIO_UNSUPPORTED
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->physical_width = 217;  // 216.96 mm
	params->physical_height = 136; // 135.60 mm
