...
//add by hongzhy for e7801
#if GTP_CHANGE_X2Y
    s32 temp;
#endif
//hongzhy

    static int x_history[GTP_MAX_TOUCH+1];
    static int y_history[GTP_MAX_TOUCH+1];
        ...
        if (touch_num)
        {
            for (i = 0; i < touch_num; i++)
            {
            ...
            #endif
                {
                    ...
                    x_history[id] = input_x;
                    y_history[id] = input_y;
                }
            }
        }
        else
        {
            if (pre_touch)
            {
            ...
            #endif
                {
                    ...
                    //tpd_up(0, 0, 0);
                    tpd_up(x_history[id], y_history[id], id);
                }
            }
        }
        pre_touch = touch_num;
...
#ifdef CONFIG_MALATA_E1002
	TPD_RES_X = 1280; //malata test
	TPD_RES_Y = 800; //malata test
#endif	
